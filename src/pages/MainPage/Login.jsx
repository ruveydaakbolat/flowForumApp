                ...
                <div className="text-white w-full bg-gray-800 border border-gray-700 rounded-lg shadow sm:max-w-md">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <button className="my-4 w-full bg-blue-600 hover:bg-blue-700 font-medium rounded-lg px-5 py-2.5 text-sm">Giriş Yap</button>

                            <p className="text-sm text-gray-400">
                                Hesabınız yoksa?
                                <Link className="mx-2 text-white" to={"/register"}>Kayıt Ol</Link>
                            </p>
                        </form>
                    </div>
                </div>
